...
class DistributionTests(unittest.TestCase):
    ...
    def test_bootstrap_setup_only_contract(self):
        ...
        self.assertIn('report the checked tasks, then stop', prompt)
        self.assertIn('docs/bootstrap.md', prompt)
        self.assertIn('**It does\nnot implement the application', readme)
